...
from src.domain.user import UserModel, Users, UserRoleUpdateForm
...
@router.post(
    "/{user_id}", response_model=UserResponse, dependencies=[Depends(get_verified_user)]
)
async def insert_new_user(user_id: str):
